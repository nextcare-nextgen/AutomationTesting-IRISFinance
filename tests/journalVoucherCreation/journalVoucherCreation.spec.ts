...
test('NXGF-TC-3864: TC_017_Journal Voucher creation_Verify that the Voucher date is selected default current date', async ({ page }) => {
    ...
    await test.step("Verified that the Voucher date is selected default current date", async () => {
        await journalVoucherCreationPage.verifyCurrentVoucherDateFromCalender();
    })
});

test('NXGF-TC-3865: TC_018_Journal Voucher creation_Verify that the Voucher type is a mandatory field', async ({ page }) => {
    ...
    await test.step("Verified that the Voucher type is a mandatory field", async () => {
        await journalVoucherCreationPage.verifyVoucherTypeMandate();
    })
});
...
test('NXGF-TC-3872,NXGF-TC-3873: TC_033_Journal Voucher lookup_Verify that the Account name, description, Amount, Currency, Amount EUR1, Amount EUR2, Valid date, Debit and save button', async ({ page }) => {
    ...
    await test.step("Verifed that the Account name, description, Amount, Currency, Amount EUR1, Amount EUR2, Valid date, Debit and save button", async () => {
...
test('NXGF-TC-3882: TC_051_Journal Voucher creation_Verify that the user is able to edit the previously entered information', async ({ page }) => {
    ...
    //     await journalVoucherCreationPage.selectAccountName(JournalVoucherCreationPageData['TC_051_Journal_Voucher_Creation'].value1);
    // })
