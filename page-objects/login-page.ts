...
export class LoginPage {
    ...
    constructor(page: Page) {
       ...
       //this.signinButton = page.locator("//button[@type='submit']");
        ...
        this.userNameOrEmailInputField = page.locator("//mat-label[contains(normalize-space(.), 'Email or Username')]/ancestor::mat-form-field//input");
        this.passwordInputField = page.locator("//mat-label[contains(normalize-space(.), 'Password')]/ancestor::mat-form-field//input");
        //this.signinButton = page.locator('span[title="Sign in"]');
       // code updated 19-12-2024
        this.signinButton = page.locator("//button[@type='submit']");
